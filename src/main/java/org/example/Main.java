                ...
                if (s.equals("castling0")) {
                    ...
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn)) {
                            ...
                            if (isInCheck) {
                                if (board.nowPlayerColor().equals("white")) {
                                    System.out.println("Игра окончена");
                                    System.out.println("Шах белому королю");
                                    System.out.println("Введите replay для перезапуска игры");

                                } else {
                                    System.out.println("Игра окончена");
                                    System.out.println("Шах черному королю");
                                    System.out.println("Введите replay для перезапуска игры");
                                }
                            }
